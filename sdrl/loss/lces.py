...
class PartLCes(nn.Module):
    """ Part-level cross-entropy with agreement smoothing """
    def __init__(self):
        super(PartLCes, self).__init__()
...
class LCes(nn.Module):
    """ Global cross-entropy with pseudo-label refinement (L_ces) """
    def __init__(self, lam=0.5):
        super(LCes, self).__init__()
...
class CameraProxy(nn.Module):
    ...
    def __init__(self, num_features, num_samples, num_hards=50, temp=0.07):
        super(CameraProxy, self).__init__()
